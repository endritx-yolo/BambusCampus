namespace Example
{
	...
	public sealed class Menu : NetworkBehaviour
	{
		...
		private void ToggleFullScreen()
		{
			...
			foreach (Resolution resolution in resolutions)
			{
				...
				if (resolutionSize >= maxResolutionSize)
				{
					...
					if (refreshRate >= maxResolutionRefreshRate)
					{
						maxResolutionSize        = resolutionSize;
						maxResolutionRefreshRate = refreshRate;
		...
		private void SetResolution(int width, int height, FullScreenMode fullScreenMode, Resolution resolution)
		{
#if UNITY_2022_3_OR_NEWER
